                    ...
                    <div class="animate__animated p-6" :class="[$store.app.animation]">
                        <div class="panel p-5">
                            @if ($source === 'process_commu')
                                ...
                                <form method="POST"
                                    action="{{ route('performance_menege.update',['performance_menege' => $data->id, 'source' => 'process_commu']) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-5">
                            ...
                            @elseif ($source === 'process_createinnovation')
                                ...
                                <form method="POST"
                                    action="{{ route('performance_menege.update',['performance_menege' => $data->id, 'source' => 'process_createinnovation']) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-5">
                                        <label for="name">รายละเอียด</label>
                            ...
                            @elseif ($source === 'process_learn')
                                ...
                                <form method="POST"
                                    action="{{ route('performance_menege.update',['performance_menege' => $data->id, 'source' => 'process_learn']) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-5">
                                        <label for="name">รายละเอียด</label>
