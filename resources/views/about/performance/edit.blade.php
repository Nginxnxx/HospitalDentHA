...
@section('title', 'แก้ไขข้อมูลระบบพัฒนาคุณภาพ')
@section('content')
            ...
            <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
                <div class="main-content flex flex-col min-h-screen">
                    <div class="animate__animated p-6" :class="[$store.app.animation]">
                        <div class="panel p-5">  
                            <h4 class="text text-center mb-6 text-xl font-bold md:text-1xl">แก้ไขข้อมูลระบบพัฒนาคุณภาพ/ธรรมาภิบาล</h4>                      
                            <form method="POST" action="{{ route('performance_menege.update',['performance_menege' => $data->id, 'source' => 'devquality']) }}" >
                                @csrf        
                                @method('PUT')                 
                                <div class="mb-5">
