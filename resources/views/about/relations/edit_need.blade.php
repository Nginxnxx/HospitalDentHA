...
@section('title', 'แก้ไขข้อมูลกลุ่มผู้รับผลงานอื่น ๆ และความต้องการ')
@section('content')
            ...
            <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
                <div class="main-content flex flex-col min-h-screen">
                    <div class="animate__animated p-6" :class="[$store.app.animation]">
                        <div class="panel p-5">  
                            <h4 class="text text-center mb-6 text-xl font-bold md:text-1xl">แก้ไขข้อมูลกลุ่มผู้รับผลงานอื่น ๆ และความต้องการ</h4>                      
                            <form method="POST" action="{{ route('need.update', $need['id']) }}" >
                                ...
                                <div class="mb-5">
                                    ...
                                    <textarea id="detail" name="detail" rows="3"
                                        class="form-textarea min-h-[130px] resize-none">{{ $need->detail}}</textarea>
                                </div>                               
