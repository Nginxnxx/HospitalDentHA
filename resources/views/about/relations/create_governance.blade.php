...
@section('title', 'เพิ่มข้อมูลระบบกำกับดูแลองค์กร')
@section('content')
            ...
            <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
                <div class="main-content flex flex-col min-h-screen">
                    <div class="animate__animated p-6" :class="[$store.app.animation]">
                        <div class="panel p-5">
                            <h4 class="text text-center mb-6 text-xl font-bold md:text-1xl">เพิ่มข้อมูลระบบกำกับดูแลองค์กร</h4>
                            <form method="POST" action="{{ route('relations_manage.store') }}">
                                @csrf 
                                <div class="mb-5">
                                    <label for="name">ชื่อหัวข้อ</label>
                                    <input id="name" name="name" rows="3" placeholder="กรอกหัวข้อ"
                                        class="form-input"/>
                                </div>  
                                <div class="mb-5">
