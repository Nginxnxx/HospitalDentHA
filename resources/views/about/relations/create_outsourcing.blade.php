...
@section('title', 'เพิ่มข้อมูลบริการที่มีการจ้างเหมามาจากภายนอก')
@section('content')
            ...
            <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
                <div class="main-content flex flex-col min-h-screen">
                    <div class="animate__animated p-6" :class="[$store.app.animation]">
                        <div class="panel p-5">
                            <h4 class="text text-center mb-6 text-xl font-bold md:text-1xl">เพิ่มข้อมูลบริการที่มีการจ้างเหมามาจากภายนอก</h4>
                            <form method="POST" action="{{ route('outsourcing.store') }}">
                                @csrf 
                                <div class="mb-5">
                                    <label for="name">บริการจ้างเหมา</label>
                                    <input id="name" name="name" rows="3" placeholder="กรอกรายการบริการจ้างเหมา"
                                        class="form-input"/>
                                </div>
                                <div class="mb-5">
